...
use HtmlSanitizer\Extension\MathMl\Node\factorofNode;
 ...
 * @final
 */
class factorofNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new factorofNode($cursor->node);
    }
}
