...
use HtmlSanitizer\Extension\MathMl\Node\domainofapplicationNode;
 ...
 * @final
 */
class domainofapplicationNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new domainofapplicationNode($cursor->node);
    }
}
