...
use HtmlSanitizer\Extension\MathMl\Node\plusNode;
 ...
 * @final
 */
class plusNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new plusNode($cursor->node);
    }
}
