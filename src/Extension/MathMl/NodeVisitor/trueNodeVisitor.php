...
use HtmlSanitizer\Extension\MathMl\Node\TrueNode;
 ...
 * @final
 */
class TrueNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new TrueNode($cursor->node);
    }
}
