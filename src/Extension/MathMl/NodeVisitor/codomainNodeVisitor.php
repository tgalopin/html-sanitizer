...
use HtmlSanitizer\Extension\MathMl\Node\codomainNode;
 ...
 * @final
 */
class codomainNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new codomainNode($cursor->node);
    }
}
