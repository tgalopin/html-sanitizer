...
use HtmlSanitizer\Extension\MathMl\Node\limitNode;
 ...
 * @final
 */
class limitNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new limitNode($cursor->node);
    }
}
