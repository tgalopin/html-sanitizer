...
use HtmlSanitizer\Extension\MathMl\Node\forallNode;
 ...
 * @final
 */
class forallNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new forallNode($cursor->node);
    }
}
