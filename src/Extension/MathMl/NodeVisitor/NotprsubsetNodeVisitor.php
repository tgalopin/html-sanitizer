...
use HtmlSanitizer\Extension\MathMl\Node\NotprsubsetNode;
 ...
 * @final
 */
class NotprsubsetNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new NotprsubsetNode($cursor->node);
    }
}
