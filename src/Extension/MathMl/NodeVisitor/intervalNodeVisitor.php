...
use HtmlSanitizer\Extension\MathMl\Node\intervalNode;
 ...
 * @final
 */
class intervalNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new intervalNode($cursor->node);
    }
}
