...
use HtmlSanitizer\Extension\MathMl\Node\MrootNode;
 ...
 * @final
 */
class MrootNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new MrootNode($cursor->node);
    }
}
