...
use HtmlSanitizer\Extension\MathMl\Node\bvarNode;
 ...
 * @final
 */
class bvarNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new bvarNode($cursor->node);
    }
}
