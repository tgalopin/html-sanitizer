...
use HtmlSanitizer\Extension\MathMl\Node\msrowNode;
 ...
 * @final
 */
class msrowNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new msrowNode($cursor->node);
    }
}
