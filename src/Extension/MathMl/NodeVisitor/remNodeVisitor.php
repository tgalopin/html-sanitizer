...
use HtmlSanitizer\Extension\MathMl\Node\remNode;
 ...
 * @final
 */
class remNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new remNode($cursor->node);
    }
}
