...
use HtmlSanitizer\Extension\MathMl\Node\SumNode;
 ...
 * @final
 */
class SumNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new SumNode($cursor->node);
    }
}
