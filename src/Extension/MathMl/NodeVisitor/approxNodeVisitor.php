...
use HtmlSanitizer\Extension\MathMl\Node\approxNode;
 ...
 * @final
 */
class approxNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new approxNode($cursor->node);
    }
}
