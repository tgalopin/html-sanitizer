...
use HtmlSanitizer\Extension\MathMl\Node\mtdNode;
 ...
 * @final
 */
class mtdNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new mtdNode($cursor->node);
    }
}
