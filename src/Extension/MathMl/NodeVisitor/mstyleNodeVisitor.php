...
use HtmlSanitizer\Extension\MathMl\Node\mstyleNode;
 ...
 * @final
 */
class mstyleNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new mstyleNode($cursor->node);
    }
}
