...
use HtmlSanitizer\Extension\MathMl\Node\msgroupNode;
 ...
 * @final
 */
class msgroupNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new msgroupNode($cursor->node);
    }
}
