...
use HtmlSanitizer\Extension\MathMl\Node\ListNode;
 ...
 * @final
 */
class ListNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new ListNode($cursor->node);
    }
}
