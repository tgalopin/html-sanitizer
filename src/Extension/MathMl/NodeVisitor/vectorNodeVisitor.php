...
use HtmlSanitizer\Extension\MathMl\Node\vectorNode;
 ...
 * @final
 */
class vectorNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new vectorNode($cursor->node);
    }
}
