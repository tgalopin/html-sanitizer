...
use HtmlSanitizer\Extension\MathMl\Node\mglyphNode;
 ...
 * @final
 */
class mglyphNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new mglyphNode($cursor->node);
    }
}
