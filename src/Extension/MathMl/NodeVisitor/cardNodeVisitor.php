...
use HtmlSanitizer\Extension\MathMl\Node\cardNode;
 ...
 * @final
 */
class cardNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new cardNode($cursor->node);
    }
}
