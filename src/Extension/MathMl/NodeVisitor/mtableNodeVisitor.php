...
use HtmlSanitizer\Extension\MathMl\Node\mtableNode;
 ...
 * @final
 */
class mtableNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new mtableNode($cursor->node);
    }
}
