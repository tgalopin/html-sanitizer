...
use HtmlSanitizer\Extension\MathMl\Node\relnNode;
 ...
 * @final
 */
class relnNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new relnNode($cursor->node);
    }
}
