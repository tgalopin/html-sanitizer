...
use HtmlSanitizer\Extension\MathMl\Node\partialdiffNode;
 ...
 * @final
 */
class partialdiffNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new partialdiffNode($cursor->node);
    }
}
