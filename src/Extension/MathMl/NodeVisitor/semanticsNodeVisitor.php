...
use HtmlSanitizer\Extension\MathMl\Node\semanticsNode;
 ...
 * @final
 */
class semanticsNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new semanticsNode($cursor->node);
    }
}
