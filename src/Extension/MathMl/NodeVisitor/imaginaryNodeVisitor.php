...
use HtmlSanitizer\Extension\MathMl\Node\imaginaryNode;
 ...
 * @final
 */
class imaginaryNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new imaginaryNode($cursor->node);
    }
}
