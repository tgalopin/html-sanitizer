...
use HtmlSanitizer\Extension\MathMl\Node\andNode;
 ...
 * @final
 */
class andNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new andNode($cursor->node);
    }
}
