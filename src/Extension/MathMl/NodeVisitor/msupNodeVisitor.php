...
use HtmlSanitizer\Extension\MathMl\Node\msupNode;
 ...
 * @final
 */
class msupNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new msupNode($cursor->node);
    }
}
