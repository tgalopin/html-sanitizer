...
use HtmlSanitizer\Extension\MathMl\Node\ceilingNode;
 ...
 * @final
 */
class ceilingNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new ceilingNode($cursor->node);
    }
}
