...
use HtmlSanitizer\Extension\MathMl\Node\secNode;
 ...
 * @final
 */
class secNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new secNode($cursor->node);
    }
}
