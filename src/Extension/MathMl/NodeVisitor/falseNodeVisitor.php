...
use HtmlSanitizer\Extension\MathMl\Node\falseNode;
 ...
 * @final
 */
class falseNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new falseNode($cursor->node);
    }
}
