...
use HtmlSanitizer\Extension\MathMl\Node\factorialNode;
 ...
 * @final
 */
class factorialNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new factorialNode($cursor->node);
    }
}
