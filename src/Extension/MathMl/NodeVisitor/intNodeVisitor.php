...
use HtmlSanitizer\Extension\MathMl\Node\intNode;
 ...
 * @final
 */
class intNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new intNode($cursor->node);
    }
}
