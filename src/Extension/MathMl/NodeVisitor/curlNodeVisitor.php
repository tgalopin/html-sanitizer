...
use HtmlSanitizer\Extension\MathMl\Node\curlNode;
 ...
 * @final
 */
class curlNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new curlNode($cursor->node);
    }
}
