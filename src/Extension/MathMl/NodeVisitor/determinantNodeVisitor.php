...
use HtmlSanitizer\Extension\MathMl\Node\determinantNode;
 ...
 * @final
 */
class determinantNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new determinantNode($cursor->node);
    }
}
