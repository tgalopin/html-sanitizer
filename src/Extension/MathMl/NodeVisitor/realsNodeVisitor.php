...
use HtmlSanitizer\Extension\MathMl\Node\realsNode;
 ...
 * @final
 */
class realsNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new realsNode($cursor->node);
    }
}
