...
use HtmlSanitizer\Extension\MathMl\Node\integersNode;
 ...
 * @final
 */
class integersNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new integersNode($cursor->node);
    }
}
