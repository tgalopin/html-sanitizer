...
use HtmlSanitizer\Extension\MathMl\Node\lowlimitNode;
 ...
 * @final
 */
class lowlimitNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new lowlimitNode($cursor->node);
    }
}
