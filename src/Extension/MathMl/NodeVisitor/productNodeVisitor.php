...
use HtmlSanitizer\Extension\MathMl\Node\productNode;
 ...
 * @final
 */
class productNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new productNode($cursor->node);
    }
}
