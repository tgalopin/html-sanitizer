...
use HtmlSanitizer\Extension\MathMl\Node\maxNode;
 ...
 * @final
 */
class maxNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new maxNode($cursor->node);
    }
}
