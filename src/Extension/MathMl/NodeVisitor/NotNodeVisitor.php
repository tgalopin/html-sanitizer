...
use HtmlSanitizer\Extension\MathMl\Node\NotNode;
 ...
 * @final
 */
class NotNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new NotNode($cursor->node);
    }
}
