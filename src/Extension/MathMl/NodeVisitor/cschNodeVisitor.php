...
use HtmlSanitizer\Extension\MathMl\Node\cschNode;
 ...
 * @final
 */
class cschNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new cschNode($cursor->node);
    }
}
