...
use HtmlSanitizer\Extension\MathMl\Node\intersectNode;
 ...
 * @final
 */
class intersectNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new intersectNode($cursor->node);
    }
}
