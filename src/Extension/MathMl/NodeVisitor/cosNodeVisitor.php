...
use HtmlSanitizer\Extension\MathMl\Node\cosNode;
 ...
 * @final
 */
class cosNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new cosNode($cursor->node);
    }
}
