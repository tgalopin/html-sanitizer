...
use HtmlSanitizer\Extension\MathMl\Node\unionNode;
 ...
 * @final
 */
class unionNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new unionNode($cursor->node);
    }
}
