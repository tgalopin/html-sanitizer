...
use HtmlSanitizer\Extension\MathMl\Node\composeNode;
 ...
 * @final
 */
class composeNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new composeNode($cursor->node);
    }
}
