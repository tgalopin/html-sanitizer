...
use HtmlSanitizer\Extension\MathMl\Node\arccoshNode;
 ...
 * @final
 */
class arccoshNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new arccoshNode($cursor->node);
    }
}
