...
use HtmlSanitizer\Extension\MathMl\Node\rationalsNode;
 ...
 * @final
 */
class rationalsNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new rationalsNode($cursor->node);
    }
}
