...
use HtmlSanitizer\Extension\MathMl\Node\sepNode;
 ...
 * @final
 */
class sepNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new sepNode($cursor->node);
    }
}
