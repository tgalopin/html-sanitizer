...
use HtmlSanitizer\Extension\MathMl\Node\setNode;
 ...
 * @final
 */
class setNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new setNode($cursor->node);
    }
}
