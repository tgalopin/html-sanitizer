...
use HtmlSanitizer\Extension\MathMl\Node\inverseNode;
 ...
 * @final
 */
class inverseNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new inverseNode($cursor->node);
    }
}
