...
use HtmlSanitizer\Extension\MathMl\Node\TimesNode;
 ...
 * @final
 */
class TimesNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new TimesNode($cursor->node);
    }
}
