...
use HtmlSanitizer\Extension\MathMl\Node\gradNode;
 ...
 * @final
 */
class gradNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new gradNode($cursor->node);
    }
}
