...
use HtmlSanitizer\Extension\MathMl\Node\ArgNode;
 ...
 * @final
 */
class ArgNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new ArgNode($cursor->node);
    }
}
