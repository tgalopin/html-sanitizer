...
use HtmlSanitizer\Extension\MathMl\Node\shareNode;
 ...
 * @final
 */
class shareNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new shareNode($cursor->node);
    }
}
