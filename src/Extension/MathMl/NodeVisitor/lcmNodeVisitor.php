...
use HtmlSanitizer\Extension\MathMl\Node\lcmNode;
 ...
 * @final
 */
class lcmNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new lcmNode($cursor->node);
    }
}
