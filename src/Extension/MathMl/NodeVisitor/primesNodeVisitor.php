...
use HtmlSanitizer\Extension\MathMl\Node\primesNode;
 ...
 * @final
 */
class primesNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new primesNode($cursor->node);
    }
}
