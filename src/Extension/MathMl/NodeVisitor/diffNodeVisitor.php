...
use HtmlSanitizer\Extension\MathMl\Node\diffNode;
 ...
 * @final
 */
class diffNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new diffNode($cursor->node);
    }
}
