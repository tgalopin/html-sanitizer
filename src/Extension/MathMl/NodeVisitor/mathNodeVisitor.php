...
use HtmlSanitizer\Extension\MathMl\Node\mathNode;
 ...
 * @final
 */
class mathNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new mathNode($cursor->node);
    }
}
