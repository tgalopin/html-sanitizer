...
use HtmlSanitizer\Extension\MathMl\Node\NotinNode;
 ...
 * @final
 */
class NotinNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new NotinNode($cursor->node);
    }
}
