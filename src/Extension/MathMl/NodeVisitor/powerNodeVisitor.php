...
use HtmlSanitizer\Extension\MathMl\Node\powerNode;
 ...
 * @final
 */
class powerNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new powerNode($cursor->node);
    }
}
