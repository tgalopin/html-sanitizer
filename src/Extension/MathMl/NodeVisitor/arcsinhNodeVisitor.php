...
use HtmlSanitizer\Extension\MathMl\Node\arcsinhNode;
 ...
 * @final
 */
class arcsinhNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new arcsinhNode($cursor->node);
    }
}
