...
use HtmlSanitizer\Extension\MathMl\Node\MtextNode;
 ...
 * @final
 */
class MtextNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new MtextNode($cursor->node);
    }
}
