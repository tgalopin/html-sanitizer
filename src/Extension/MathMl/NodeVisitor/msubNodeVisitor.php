...
use HtmlSanitizer\Extension\MathMl\Node\msubNode;
 ...
 * @final
 */
class msubNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new msubNode($cursor->node);
    }
}
