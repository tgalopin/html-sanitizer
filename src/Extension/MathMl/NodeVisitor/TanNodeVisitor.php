...
use HtmlSanitizer\Extension\MathMl\Node\TanNode;
 ...
 * @final
 */
class TanNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new TanNode($cursor->node);
    }
}
