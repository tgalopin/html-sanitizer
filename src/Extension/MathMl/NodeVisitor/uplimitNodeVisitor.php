...
use HtmlSanitizer\Extension\MathMl\Node\uplimitNode;
 ...
 * @final
 */
class uplimitNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new uplimitNode($cursor->node);
    }
}
