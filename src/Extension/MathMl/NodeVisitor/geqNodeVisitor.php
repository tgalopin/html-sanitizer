...
use HtmlSanitizer\Extension\MathMl\Node\GeqNode;
 ...
 * @final
 */
class GeqNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new GeqNode($cursor->node);
    }
}
