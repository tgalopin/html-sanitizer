...
use HtmlSanitizer\Extension\MathMl\Node\eulergammaNode;
 ...
 * @final
 */
class eulergammaNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new eulergammaNode($cursor->node);
    }
}
