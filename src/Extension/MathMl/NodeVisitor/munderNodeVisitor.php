...
use HtmlSanitizer\Extension\MathMl\Node\munderNode;
 ...
 * @final
 */
class munderNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new munderNode($cursor->node);
    }
}
