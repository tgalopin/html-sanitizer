...
use HtmlSanitizer\Extension\MathMl\Node\malignmarkNode;
 ...
 * @final
 */
class malignmarkNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new malignmarkNode($cursor->node);
    }
}
