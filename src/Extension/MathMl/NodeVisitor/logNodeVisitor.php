...
use HtmlSanitizer\Extension\MathMl\Node\logNode;
 ...
 * @final
 */
class logNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new logNode($cursor->node);
    }
}
