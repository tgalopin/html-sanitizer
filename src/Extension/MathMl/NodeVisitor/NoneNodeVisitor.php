...
use HtmlSanitizer\Extension\MathMl\Node\NoneNode;
 ...
 * @final
 */
class NoneNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new NoneNode($cursor->node);
    }
}
