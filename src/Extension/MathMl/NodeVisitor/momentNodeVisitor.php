...
use HtmlSanitizer\Extension\MathMl\Node\momentNode;
 ...
 * @final
 */
class momentNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new momentNode($cursor->node);
    }
}
