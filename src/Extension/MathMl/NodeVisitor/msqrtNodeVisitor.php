...
use HtmlSanitizer\Extension\MathMl\Node\msqrtNode;
 ...
 * @final
 */
class msqrtNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new msqrtNode($cursor->node);
    }
}
