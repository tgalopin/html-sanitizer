...
use HtmlSanitizer\Extension\MathMl\Node\ArccosNode;
 ...
 * @final
 */
class ArccosNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new ArccosNode($cursor->node);
    }
}
