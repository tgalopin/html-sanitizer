...
use HtmlSanitizer\Extension\MathMl\Node\xorNode;
 ...
 * @final
 */
class xorNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new xorNode($cursor->node);
    }
}
