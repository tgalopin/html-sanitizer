...
use HtmlSanitizer\Extension\MathMl\Node\mprescriptsNode;
 ...
 * @final
 */
class mprescriptsNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new mprescriptsNode($cursor->node);
    }
}
