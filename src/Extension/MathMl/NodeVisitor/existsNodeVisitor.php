...
use HtmlSanitizer\Extension\MathMl\Node\ExistsNode;
 ...
 * @final
 */
class ExistsNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new ExistsNode($cursor->node);
    }
}
