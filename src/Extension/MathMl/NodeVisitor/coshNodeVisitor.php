...
use HtmlSanitizer\Extension\MathMl\Node\coshNode;
 ...
 * @final
 */
class coshNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new coshNode($cursor->node);
    }
}
