...
use HtmlSanitizer\Extension\MathMl\Node\exponentialeNode;
 ...
 * @final
 */
class exponentialeNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new exponentialeNode($cursor->node);
    }
}
