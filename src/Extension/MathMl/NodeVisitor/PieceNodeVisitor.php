...
use HtmlSanitizer\Extension\MathMl\Node\PieceNode;
 ...
 * @final
 */
class PieceNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new PieceNode($cursor->node);
    }
}
