...
use HtmlSanitizer\Extension\MathMl\Node\annotationNode;
 ...
 * @final
 */
class annotationNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new annotationNode($cursor->node);
    }
}
