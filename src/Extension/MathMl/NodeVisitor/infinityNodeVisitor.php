...
use HtmlSanitizer\Extension\MathMl\Node\infinityNode;
 ...
 * @final
 */
class infinityNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new infinityNode($cursor->node);
    }
}
