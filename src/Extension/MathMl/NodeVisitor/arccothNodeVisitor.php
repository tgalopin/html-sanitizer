...
use HtmlSanitizer\Extension\MathMl\Node\arccothNode;
 ...
 * @final
 */
class arccothNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new arccothNode($cursor->node);
    }
}
