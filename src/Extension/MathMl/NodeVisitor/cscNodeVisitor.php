...
use HtmlSanitizer\Extension\MathMl\Node\cscNode;
 ...
 * @final
 */
class cscNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new cscNode($cursor->node);
    }
}
