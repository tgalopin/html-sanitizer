...
use HtmlSanitizer\Extension\MathMl\Node\rootNode;
 ...
 * @final
 */
class rootNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new rootNode($cursor->node);
    }
}
