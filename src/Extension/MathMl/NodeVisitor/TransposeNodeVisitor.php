...
use HtmlSanitizer\Extension\MathMl\Node\TransposeNode;
 ...
 * @final
 */
class TransposeNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new TransposeNode($cursor->node);
    }
}
