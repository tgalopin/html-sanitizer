...
use HtmlSanitizer\Extension\MathMl\Node\DomainNode;
 ...
 * @final
 */
class DomainNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new DomainNode($cursor->node);
    }
}
