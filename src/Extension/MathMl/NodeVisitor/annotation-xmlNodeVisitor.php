...
use HtmlSanitizer\Extension\MathMl\Node\annotation-xmlNode;
 ...
 * @final
 */
class annotation-xmlNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new annotation-xmlNode($cursor->node);
    }
}
