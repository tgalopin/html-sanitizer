...
use HtmlSanitizer\Extension\MathMl\Node\ImaginaryiNode;
 ...
 * @final
 */
class ImaginaryiNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new ImaginaryiNode($cursor->node);
    }
}
