...
use HtmlSanitizer\Extension\MathMl\Node\NaturalnumbersNode;
 ...
 * @final
 */
class NaturalnumbersNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new NaturalnumbersNode($cursor->node);
    }
}
