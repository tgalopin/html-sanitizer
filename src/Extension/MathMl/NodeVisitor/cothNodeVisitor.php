...
use HtmlSanitizer\Extension\MathMl\Node\cothNode;
 ...
 * @final
 */
class cothNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new cothNode($cursor->node);
    }
}
