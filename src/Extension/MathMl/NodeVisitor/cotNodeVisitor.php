...
use HtmlSanitizer\Extension\MathMl\Node\cotNode;
 ...
 * @final
 */
class cotNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new cotNode($cursor->node);
    }
}
