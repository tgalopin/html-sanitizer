...
use HtmlSanitizer\Extension\MathMl\Node\conjugateNode;
 ...
 * @final
 */
class conjugateNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new conjugateNode($cursor->node);
    }
}
