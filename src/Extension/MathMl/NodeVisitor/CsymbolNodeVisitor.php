...
use HtmlSanitizer\Extension\MathMl\Node\CsymbolNode;
 ...
 * @final
 */
class CsymbolNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new CsymbolNode($cursor->node);
    }
}
