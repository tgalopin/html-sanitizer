...
use HtmlSanitizer\Extension\MathMl\Node\arcsechNode;
 ...
 * @final
 */
class arcsechNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new arcsechNode($cursor->node);
    }
}
