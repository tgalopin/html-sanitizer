...
use HtmlSanitizer\Extension\MathMl\Node\scalarproductNode;
 ...
 * @final
 */
class scalarproductNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new scalarproductNode($cursor->node);
    }
}
