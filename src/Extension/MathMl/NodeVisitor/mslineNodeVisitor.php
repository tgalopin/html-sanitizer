...
use HtmlSanitizer\Extension\MathMl\Node\mslineNode;
 ...
 * @final
 */
class mslineNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new mslineNode($cursor->node);
    }
}
