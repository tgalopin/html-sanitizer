...
use HtmlSanitizer\Extension\MathMl\Node\absNode;
 ...
 * @final
 */
class absNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new absNode($cursor->node);
    }
}
