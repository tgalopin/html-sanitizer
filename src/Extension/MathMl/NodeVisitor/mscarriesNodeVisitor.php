...
use HtmlSanitizer\Extension\MathMl\Node\mscarriesNode;
 ...
 * @final
 */
class mscarriesNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new mscarriesNode($cursor->node);
    }
}
