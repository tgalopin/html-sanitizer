...
use HtmlSanitizer\Extension\MathMl\Node\bindNode;
 ...
 * @final
 */
class bindNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new bindNode($cursor->node);
    }
}
