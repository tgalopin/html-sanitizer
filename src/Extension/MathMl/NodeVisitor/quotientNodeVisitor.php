...
use HtmlSanitizer\Extension\MathMl\Node\quotientNode;
 ...
 * @final
 */
class quotientNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new quotientNode($cursor->node);
    }
}
