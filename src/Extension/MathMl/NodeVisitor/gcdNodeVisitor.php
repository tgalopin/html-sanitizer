...
use HtmlSanitizer\Extension\MathMl\Node\gcdNode;
 ...
 * @final
 */
class gcdNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new gcdNode($cursor->node);
    }
}
