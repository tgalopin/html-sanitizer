...
use HtmlSanitizer\Extension\MathMl\Node\applyNode;
 ...
 * @final
 */
class applyNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new applyNode($cursor->node);
    }
}
