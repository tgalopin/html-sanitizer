...
use HtmlSanitizer\Extension\MathMl\Node\minusNode;
 ...
 * @final
 */
class minusNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new minusNode($cursor->node);
    }
}
