...
use HtmlSanitizer\Extension\MathMl\Node\prsubsetNode;
 ...
 * @final
 */
class prsubsetNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new prsubsetNode($cursor->node);
    }
}
