...
use HtmlSanitizer\Extension\MathMl\Node\selectorNode;
 ...
 * @final
 */
class selectorNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new selectorNode($cursor->node);
    }
}
