...
use HtmlSanitizer\Extension\MathMl\Node\divideNode;
 ...
 * @final
 */
class divideNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new divideNode($cursor->node);
    }
}
