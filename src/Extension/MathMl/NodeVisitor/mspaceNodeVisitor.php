...
use HtmlSanitizer\Extension\MathMl\Node\mspaceNode;
 ...
 * @final
 */
class mspaceNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new mspaceNode($cursor->node);
    }
}
