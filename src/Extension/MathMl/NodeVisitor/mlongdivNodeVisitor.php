...
use HtmlSanitizer\Extension\MathMl\Node\mlongdivNode;
 ...
 * @final
 */
class mlongdivNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new mlongdivNode($cursor->node);
    }
}
