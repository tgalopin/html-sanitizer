...
use HtmlSanitizer\Extension\MathMl\Node\MatrixrowNode;
 ...
 * @final
 */
class MatrixrowNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new MatrixrowNode($cursor->node);
    }
}
