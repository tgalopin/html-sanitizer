...
use HtmlSanitizer\Extension\MathMl\Node\setdiffNode;
 ...
 * @final
 */
class setdiffNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new setdiffNode($cursor->node);
    }
}
