...
use HtmlSanitizer\Extension\MathMl\Node\equivalentNode;
 ...
 * @final
 */
class equivalentNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new equivalentNode($cursor->node);
    }
}
