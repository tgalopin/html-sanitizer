...
use HtmlSanitizer\Extension\MathMl\Node\conditionNode;
 ...
 * @final
 */
class conditionNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new conditionNode($cursor->node);
    }
}
