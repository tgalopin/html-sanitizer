...
use HtmlSanitizer\Extension\MathMl\Node\arccscNode;
 ...
 * @final
 */
class arccscNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new arccscNode($cursor->node);
    }
}
