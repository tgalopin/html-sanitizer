...
use HtmlSanitizer\Extension\MathMl\Node\MstackNode;
 ...
 * @final
 */
class MstackNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new MstackNode($cursor->node);
    }
}
