...
use HtmlSanitizer\Extension\MathMl\Node\cbytesNode;
 ...
 * @final
 */
class cbytesNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new cbytesNode($cursor->node);
    }
}
