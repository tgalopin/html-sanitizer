...
use HtmlSanitizer\Extension\MathMl\Node\declareNode;
 ...
 * @final
 */
class declareNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new declareNode($cursor->node);
    }
}
