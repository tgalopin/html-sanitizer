...
use HtmlSanitizer\Extension\MathMl\Node\outerproductNode;
 ...
 * @final
 */
class outerproductNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new outerproductNode($cursor->node);
    }
}
