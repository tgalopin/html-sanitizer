...
use HtmlSanitizer\Extension\MathMl\Node\sinNode;
 ...
 * @final
 */
class sinNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new sinNode($cursor->node);
    }
}
