...
use HtmlSanitizer\Extension\MathMl\Node\expNode;
 ...
 * @final
 */
class expNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new expNode($cursor->node);
    }
}
