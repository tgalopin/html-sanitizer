...
use HtmlSanitizer\Extension\MathMl\Node\mphantomNode;
 ...
 * @final
 */
class mphantomNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new mphantomNode($cursor->node);
    }
}
