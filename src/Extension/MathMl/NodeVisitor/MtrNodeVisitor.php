...
use HtmlSanitizer\Extension\MathMl\Node\MtrNode;
 ...
 * @final
 */
class MtrNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new MtrNode($cursor->node);
    }
}
