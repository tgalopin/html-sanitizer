...
use HtmlSanitizer\Extension\MathMl\Node\subsetNode;
 ...
 * @final
 */
class subsetNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new subsetNode($cursor->node);
    }
}
