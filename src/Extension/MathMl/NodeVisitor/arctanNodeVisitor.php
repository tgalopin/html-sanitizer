...
use HtmlSanitizer\Extension\MathMl\Node\arctanNode;
 ...
 * @final
 */
class arctanNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new arctanNode($cursor->node);
    }
}
