...
use HtmlSanitizer\Extension\MathMl\Node\moverNode;
 ...
 * @final
 */
class moverNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new moverNode($cursor->node);
    }
}
