...
use HtmlSanitizer\Extension\MathMl\Node\mscarryNode;
 ...
 * @final
 */
class mscarryNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new mscarryNode($cursor->node);
    }
}
