...
use HtmlSanitizer\Extension\MathMl\Node\arccschNode;
 ...
 * @final
 */
class arccschNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new arccschNode($cursor->node);
    }
}
