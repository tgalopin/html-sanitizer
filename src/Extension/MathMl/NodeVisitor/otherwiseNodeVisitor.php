...
use HtmlSanitizer\Extension\MathMl\Node\OtherwiseNode;
 ...
 * @final
 */
class OtherwiseNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new OtherwiseNode($cursor->node);
    }
}
