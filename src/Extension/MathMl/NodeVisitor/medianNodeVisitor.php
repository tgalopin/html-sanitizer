...
use HtmlSanitizer\Extension\MathMl\Node\medianNode;
 ...
 * @final
 */
class medianNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new medianNode($cursor->node);
    }
}
