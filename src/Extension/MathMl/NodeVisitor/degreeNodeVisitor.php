...
use HtmlSanitizer\Extension\MathMl\Node\degreeNode;
 ...
 * @final
 */
class degreeNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new degreeNode($cursor->node);
    }
}
