...
use HtmlSanitizer\Extension\MathMl\Node\arcsecNode;
 ...
 * @final
 */
class arcsecNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new arcsecNode($cursor->node);
    }
}
