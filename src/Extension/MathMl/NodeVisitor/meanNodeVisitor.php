...
use HtmlSanitizer\Extension\MathMl\Node\meanNode;
 ...
 * @final
 */
class meanNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new meanNode($cursor->node);
    }
}
