...
use HtmlSanitizer\Extension\MathMl\Node\mencloseNode;
 ...
 * @final
 */
class mencloseNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new mencloseNode($cursor->node);
    }
}
