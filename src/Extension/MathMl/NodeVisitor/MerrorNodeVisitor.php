...
use HtmlSanitizer\Extension\MathMl\Node\MerrorNode;
 ...
 * @final
 */
class MerrorNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new MerrorNode($cursor->node);
    }
}
