...
use HtmlSanitizer\Extension\MathMl\Node\TanhNode;
 ...
 * @final
 */
class TanhNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new TanhNode($cursor->node);
    }
}
