...
use HtmlSanitizer\Extension\MathMl\Node\sdevNode;
 ...
 * @final
 */
class sdevNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new sdevNode($cursor->node);
    }
}
