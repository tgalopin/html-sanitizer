...
use HtmlSanitizer\Extension\MathMl\Node\sechNode;
 ...
 * @final
 */
class sechNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new sechNode($cursor->node);
    }
}
