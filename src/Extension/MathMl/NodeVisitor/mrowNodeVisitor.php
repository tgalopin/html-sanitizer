...
use HtmlSanitizer\Extension\MathMl\Node\mrowNode;
 ...
 * @final
 */
class mrowNodeVisitor extends AbstractNodeVisitor implements NamedNodeVisitorInterface
{
    ...
    {
        return new mrowNode($cursor->node);
    }
}
